...
select sum(sal) as 'Monthly salary of all employees' from emp 
...
select count(ename) as 'Total no of employees' from emp
emp where DATEDIFF(year, hiredate, getdate())>30 and DATEDIFF(year, hiredate, getdate()) < 40 
